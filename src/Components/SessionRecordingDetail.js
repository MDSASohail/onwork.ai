...
function SessionRecordingInDetail() {
    ...
    return (
        <>
            ...
            <div className="border-2 flex gap-3 p-3 bg-white rounded-xl">
                <div className=" w-[25%] text-textLightColor bg-[#EFF4FF] p-2 h-screen overflow-y-scroll styleScrollbar rounded-xl ">
                    ...
                    {Array.from({ length: 10 }).map((eachdata, index) => <div className="bg-white my-2 relative  hover:shadow-md transition-colors shadow-borderColor hover:border-borderColor border-2  rounded-xl p-3 ">
                        ...
                        <div className="flex justify-between items-center  ">
                            ...
                            <div className="relative overflow-x-visible " onMouseLeave={() => setShowInfo(-1)}>
                                <button onClick={() => { setShowInfo(index) }} className="bg-borderColor px-6 py-2 rounded-xl text-white cursor-pointer" >Info</button>

                                <div className={`absolute border-2 border-borderColor p-3 w-72 bg-white rounded-xl left-[22%] top-10 z-50  ${index === showinfo ? "block" : "hidden"}`}>
                ...
                <div className=" flex-grow border-2 ">
                    <div className="flex items-center justify-between border-2 border-borderColor px-3 py-2 rounded-xl w-80 ">
                        ...
                        <div className="flex gap-3 items-center">
                            <div className="cursor-pointer" onClick={(e) => { navigator.clipboard.writeText("https://onwork.ai/pricing/") }}>
                                <ContentCopy />
