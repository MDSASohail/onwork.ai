...
const tableData = [
  ...
  function SessionRecording() {
   ...
   //Filter data from tableData according to active, completed. or all sessions;
    ...
    return (
        <div style={{ boxShadow: '0  4px 6px rgba(135, 102, 255, 0.3)' }} className=' px-3 py-3 my-12 shadow-2xl bg-white  rounded-3xl relative  '>
            ...
            <div className=' rounded-lg flex justify-between my-10 text-[#9F9F9F] '>
                <div className='border-2 rounded-xl'>
                <button onClick={()=>{setWhichSession(null)}} className={` my-2 border-r-2 py-1 px-3  ${whichSession === null ? "text-borderColor" :"hover:text-borderColor"}`}>All Sessions</button>
                <button onClick={()=>{setWhichSession(false)}} className={`  my-2 border-r-2 py-1 px-3  ${whichSession === false ? "text-borderColor" :"hover:text-borderColor"}`}>Completed Sessions</button>
                <button onClick={()=>{setWhichSession(true)}} className={`  my-2 border-r-2 py-1 px-3 ${whichSession === true ? "text-borderColor" :"hover:text-borderColor"}`}>Active Sessions</button>
                <button className='my-2 py-1 px-3'><Star/></button>
            ...
            <div className="h-[433px] overflow-hidden ">
                ...
                <div className="styleScrollbar h-[96%] overflow-y-scroll">
                    ...
                    <thead className=''>
                        <tr className="h-[40px] stic sticky bg-white top-0 z-50 ">
